...
#   filter = "parent.id:${split("/", var.folder_id)[1]} name:*${var.project_suffix}* labels.application_name=${var.business_code}-transformation labels.environment=${var.environment} lifecycleState=ACTIVE"
# }
